function main
  ...
  %% Parameter slider for number of bezier curves
  myhandles.n_beziers_slider=uicontrol('Units','normalized', ...
	                           'BackgroundColor',get(gcf,'Color'), ...
                               'position',[.25 .05 .5 .05],...
	                           'Min',0,'Max',myhandles.max_beziers,'Value',myhandles.n_beziers,...
	                           'Sliderstep',[0.01,0.1],...
	                           'Callback',@slider_update,...
	                           'Style','slider','Enable','on');

  % Text as a lable to update when using bezier curve slider
myhandles.n_beziers_slider_text=uicontrol('Units','normalized', ...
	'BackgroundColor','white', ...
	'HorizontalAlignment','center', ...
	'Position',[.45 .1 .1 .05],...
	'String','Number of Beziers: 50', ...
	'Style','text');
